...
namespace QL_CUAHANG_THUCUNG
{
    public partial class Pets : Form
    {
        ...
        public void dataBingDing(DataTable Pet)
        {
            ...
            txtTrangThai.DataBindings.Add("text", Pet, "TRANGTHAI");
        ...
        private void btnSuaTC_Click(object sender, EventArgs e)
        {
            ...
            if (dl.SuaTC(txtMaThuCung.Text, txtTenThuCung.Text, GIA, txtChiTietTC.Text, txtTrangThai.Text, cboLoaiThuCung.Text))
            {
        ...
        private void btnThemTC_Click(object sender, EventArgs e)
        {
            ...
            string GIA = txtGiaThuCung.Text;
            if (dl.ThemTC(txtMaThuCung.Text, txtTenThuCung.Text, GIA, txtChiTietTC.Text, txtTrangThai.Text, cboLoaiThuCung.Text))
            {
